...
|---------------------------|-------------|----------------|-------|---------------------------------------------------------------------------|
| falsy                     | falsy       | falsy          | -     | Do nothing (controller is in :stopped state)                              |
| falsy                     | truthy      | falsy          | -     | Stop the current controller instance                                      |
| falsy                     | falsy       | truthy         | -     | Start a new controller instance                                           |
| falsy                     | truthy      | truthy         | -     | Stop the current controller instance and start a new one                  |
| truthy                    | falsy       | falsy          | -     | Do nothing (controller is in :stopped state)                              |
| truthy                    | truthy      | falsy          | -     | Stop the current controller instance                                      |
| truthy                    | falsy       | truthy         | -     | Start a new controller instance                                           |
| truthy                    | truthy      | truthy         | false | Stop the current controller instance and start a new one                  |
| truthy                    | truthy      | truthy         | true  | Dispatch :keechma.on/deps-change event to the running controller instance |
